...
{
    return CTrilinos::tableRepos().get<Epetra_Object, CTrilinos_Universal_ID_t>(id);
}
...
{
    return CTrilinos::tableRepos().getConst<Epetra_Object, CTrilinos_Universal_ID_t>(id);
}
