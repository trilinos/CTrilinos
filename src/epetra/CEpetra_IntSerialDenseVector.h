...
/*! Functions Epetra_IntSerialDenseVector_Cast() and Epetra_IntSerialDenseVector_Abstract()
   ...
   and stores an RCP to it in the Epetra_IntSerialDenseVector table, while
